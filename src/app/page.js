            ...
            <div class="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
              <div class="lg:pr-8 lg:pt-4">
                <div class="lg:max-w-lg">
                  <h2 class="text-lg font-semibold leading-8 tracking-tight text-black px-20">By Arsikaprahasta</h2>
                  <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl px-20">Arsirana.jpg</p>
                </div>
              </div>
              <img src="arsirana simbol.jpg" alt="Product screenshot" class="w-[26rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[26rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
            </div>
          </div>
        </div>
        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
          <div className="flex flex-col lg:flex-row justify-between gap-8">
            <div className="w-full lg:w-5/12 flex flex-col justify-center">
              <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 pb-4"><img src="AFLO ROYAL4080-Edit.JPG" /></h1>
          ...
          <div class="container px-5 py-2 mx-auto lg:pt-24 lg:px-32">
            <div class="flex flex-wrap -m-1 md:-m-2">
              ...
              <div class="flex flex-wrap w-1/2">
                <div class="w-full p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="reels 2 after.jpg" />
                </div>
                <div class="w-1/2 p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="Untitled-1 copy.jpg" />
                </div>
                <div class="w-1/2 p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="kuy saik 2.jpg" />
            ...
            <div className="lg:flex items-stretch md:mt-12 mt-8">
              <div className="lg:w-1/2">
                <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
                  <div className="sm:w-1/2 relative">
                    ...
                    <img src="DSC02100-Edit.JPG" className="w-full" alt="" />
                  </div>
                  <div className="sm:w-1/2 sm:mt-0 mt-4 relative">
                    ...
                    <img src="DSC02053-Edit.JPG" className="w-full" alt="wall design" />
                  </div>
                </div>
                <div className="relative">
                  ...
                  <img src="DSC01922-Edit.JPG" alt="sitting place" className="w-full mt-8 md:mt-6 " />
              ...
              <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
                <div className="relative">
                  ...
                  <img src="DSC01921-Edit.JPG" alt="sitting place" className="w-full sm:block " />
                ...
                <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
                  <div className="relative w-full">
                    ...
                    <img src="DSC02282.JPG" className="w-full" alt="chair" />
                  </div>
                  <div className="relative w-full sm:mt-0 mt-4">
                    ...
                    <img src="DSC02284.JPG" className="w-full" alt="wall design" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="container px-5 py-2 mx-auto lg:pt-24 lg:px-32">
            <div class="flex flex-wrap -m-1 md:-m-2">
              <div class="flex flex-wrap w-1/2">
                <div class="w-1/2 p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="DSC01742-Edit.JPG" />
                </div>
                <div class="w-1/2 p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="DSC01730-Edit.JPG" />
                </div>
                <div class="w-full p-1 md:p-2">
                  <img alt="gallery" className="block object-cover object-center w-full h-full rounded-lg"
                    src="DSC01234.JPG" />
            ...
            <div className="lg:flex items-stretch md:mt-12 mt-8">
              <div className="lg:w-1/2">
                <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
                  <div className="sm:w-1/2 relative">
                    ...
                    <img src="DSC09977.jpg" className="w-full" alt="" />
                  </div>
                  <div className="sm:w-1/2 sm:mt-0 mt-4 relative">
                    <div>
                    ...
                    <img src="DSC09953.jpg" className="w-full" alt="wall design" />
                  </div>
                </div>
                <div className="relative">
                  <div>
                  ...
                  <img src="DSC00144.jpg" alt="sitting place" className="w-full mt-8 md:mt-6 " />
              ...
              <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
                <div className="relative">
                  ...
                  <img src="DSC00203.jpg" alt="sitting place" className="w-full sm:block " />
                ...
                <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
                  <div className="relative w-full">
                    ...
                    <img src="DSC00180.jpg" className="w-full" alt="chair" />
                  </div>
                  <div className="relative w-full sm:mt-0 mt-4">
                    <div>
                    ...
                    <img src="untitled-12.jpg" className="w-full" alt="wall design" />
                  </div>
                </div>
              </div>
            </div>
